...
//        mFlingable = attributesArray.getBoolean(R.styleable.NumberPicker_flingable, true);
        mFlingable = true;
        mSelectionDivider = context.getResources().getDrawable(R.drawable.numberpicker_selection_divider);
//        mSelectionDivider = attributesArray.getDrawable(R.styleable.NumberPicker_selectionDivider);
        ...
        mMaxHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                200,
                getResources().getDisplayMetrics());
